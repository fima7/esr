...
\begin{frame}[allowframebreaks]{Implementation.}{Insertion.}
  ...
  \resizebox{!}{43mm}{\begin{algorithm}[H]
      \caption{\href{http://fima/esr/classesr\_1\_1\_hashtable.html\#af8210e61dbd1a633337bc95bbedf0f8e}{add(key, value)}}
      \SetFuncSty{textsc}
      \SetDataSty{emph}
  ...
  \framebreak
 \resizebox{!}{43mm}{\begin{algorithm}[H]
     \caption{\href{http://fima/esr/classesr\_1\_1linkedlist.html\#ae8c7b6f0cf9b82c77c12246ad0023078}
...
\begin{frame}[allowframebreaks]{Implementation.}{Deletion.}
  \IncMargin{1em}
  \resizebox{!}{43mm}{\begin{algorithm}[H]
      \caption{\href{http://fima/esr/classesr\_1\_1\_hashtable.html\#afdf16cd1fa1af9b008c39564a4590054}
        {remove(key)}}
      \SetFuncSty{textsc}
      \SetDataSty{emph}
      \SetCommentSty{commentsty}
  ...
  \resizebox{!}{43mm}{\begin{algorithm}[H]
      \caption{\href{http://fima/esr/classesr\_1\_1linkedlist.html\#af67945ba61bad2c993e9c749d77bdb61}
...
\begin{frame}{Implementation.}{Resizing.}
  \IncMargin{1em}
  \resizebox{!}{43mm}{\begin{algorithm}[H]
      \caption{\href{http://fima/esr/classesr\_1\_1\_hashtable.html\#aa02a8639c49e951680e974a0bb6b3b38}
